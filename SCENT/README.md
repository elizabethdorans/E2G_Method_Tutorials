...
Example command: [~1 day, ~20G; varies depending on number of cells and number of candidate peak-gene links]
...
**ATTENTION: Line 21 contains an 'sbatch' commmand to submit batch jobs to Slurm on a remote cluster with 20G of memory and 1 day of runtime each. Edit this line as appropriate.**
