...
**2A**: Running the SCENT algorithm on on one candidate peak-gene link file
...
**2B:** Running the SCENT algorithm on multiple candidate peak-gene link files in parallel
